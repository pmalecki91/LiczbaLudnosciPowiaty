...
(SELECT P2020.LiczbaLudnosci - P2015.LiczbaLudnosci) AS Roznica, (SELECT  ((P2020.LiczbaLudnosci - P2015.LiczbaLudnosci) / P2015.LiczbaLudnosci)* 100.00 ) AS ProcRoznica
FROM Powiaty2020 P2020
JOIN Powiaty2015 P2015
ON P2020.IdPowiat = P2015.IdPowiat
ORDER BY (SELECT  ((P2020.LiczbaLudnosci - P2015.LiczbaLudnosci) / P2015.LiczbaLudnosci)* 100.00 ) DESC
